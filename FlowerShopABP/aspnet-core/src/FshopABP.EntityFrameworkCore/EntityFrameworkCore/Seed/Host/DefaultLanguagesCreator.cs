...
namespace FshopABP.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly FshopABPDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = FshopABPConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(FshopABPDbContext context)
    {
        _context = context;
    }
