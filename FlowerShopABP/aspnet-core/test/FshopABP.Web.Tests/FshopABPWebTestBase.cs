...
public abstract class FshopABPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static FshopABPWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(FshopABPWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<FshopABPDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<FshopABPDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<FshopABPDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<FshopABPDbContext, Task<T>> func)
    {
        T result;
